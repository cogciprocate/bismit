...
pub const SENSORY_CHORD_WIDTH_LOG2: usize = 8; // ******
pub const SENSORY_CHORD_WIDTH: u32 = 1 << SENSORY_CHORD_WIDTH_LOG2; // COLUMNS_PER_SEGMENT;

pub const SENSORY_CHORD_HEIGHT_LOG2: usize = 8; // ******
pub const SENSORY_CHORD_HEIGHT: u32 = 1 << SENSORY_CHORD_WIDTH_LOG2; // COLUMNS_PER_SEGMENT;
...
pub const SYNAPSE_REACH_LOG2: u32 = 3;
