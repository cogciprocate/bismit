...
impl Synapses {
            ...
            ) -> CmnResult<Synapses>
    {
        ...
        for tft_scheme in cell_scheme.tft_schemes() {
            ...
            tft_dims_by_tft.push(TuftDims::new(tft_scheme.dens_per_tft_l2(),
...
pub mod tests {
    ...
    // pub fn syn_idx_old(cel_layer_dims: &CorticalDims, tft_count: u32, dens_per_cel_tft: u32, syns_per_den: u32,
